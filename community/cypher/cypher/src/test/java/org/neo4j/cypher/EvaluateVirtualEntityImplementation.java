 ...
 */
public class EvaluateVirtualEntityImplementation {
    ...
    @Test
    public void MeasureCreatingRealEntities() throws Exception
    {
        GraphDatabaseService graphDb;
        StopWatch watch = new StopWatch();
        Map<String,Object> params = new HashMap<>();

        System.out.println("Real Entities");
        for(int i=1;i<max;i=i*2) {
            params.put("1", i);
    ...
    @Test
    public void MeasureCreatingVirtualEntitiesTA_failing() throws Exception
    {
        GraphDatabaseService graphDb;
        StopWatch watch = new StopWatch();
        Map<String,Object> params = new HashMap<>();

        System.out.println("Virtual Entities (whole TA,failed)");
        for(int i=1;i<max;i=i*2) {
            params.put("1", i);
    ...
    @Test
    public void MeasureCreatingRealEntitiesTA_failing() throws Exception
    {
        GraphDatabaseService graphDb;
        StopWatch watch = new StopWatch();
        Map<String,Object> params = new HashMap<>();

        System.out.println("Real Entities (whole TA,failed)");
        for(int i=1;i<max;i=i*2) {
            params.put("1", i);
    ...
    @Test
    public void MeasureMatchingVirtualEntities() throws Exception
    {
        GraphDatabaseService graphDb;
        StopWatch watch = new StopWatch();
        Map<String,Object> params = new HashMap<>();

        System.out.println("Virtual Entities (MATCH)");
        for(int i=1;i<max;i=i*2) {
            params.put("1", i);
            ...
            for(int j=0;j<size;j++){
                ...
                try (Transaction tx = graphDb.beginTx()) {
                    graphDb.execute("FOREACH (r IN range(1,{1}) | \n" +
                            ...
                            ");", params);
                    watch.start();
                    graphDb.execute("MATCH (x:User)-[y:IS_SAME_AS]->(o) RETURN x,y,o");
                    watch.stop();
                    values[p] = (double) watch.getTime();
                    p++;
                    watch.reset();
    ...
    @Test
    public void MeasureMatchingRealEntities() throws Exception
    {
        GraphDatabaseService graphDb;
        StopWatch watch = new StopWatch();
        Map<String,Object> params = new HashMap<>();

        System.out.println("Real Entities (MATCH)");
        for(int i=1;i<max;i=i*2) {
            params.put("1", i);
