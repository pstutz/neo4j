...
import org.neo4j.cypher.internal.compiler.v3_1.commands.expressions.{IdFunction, Variable}
import org.neo4j.cypher.internal.compiler.v3_1.commands.predicates.{Equals, Predicate}
import org.neo4j.cypher.internal.compiler.v3_1.executionplan.{ExecutionPlanInProgress, PlanBuilder}
import org.neo4j.cypher.internal.compiler.v3_1.pipes.matching.{Trail, TraversalMatcher}
import org.neo4j.cypher.internal.compiler.v3_1.pipes.{EntityProducer, PipeMonitor, SingleRowPipe, TraversalMatchPipe}
